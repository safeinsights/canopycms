...
From adopter request #12, an adopter's own requests list, triaged
...
to the requester: the marketing site pins `canopycms@^0.0.41`, and this
shipped well before that version.
