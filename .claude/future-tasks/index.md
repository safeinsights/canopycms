...
| [efs-cross-process-concurrency.md](efs-cross-process-concurrency.md)         | RESOLVED — epic PRs #111–#116: shared generation-marker + OCC/lockfile primitives applied to branch-registry, schema-cache, comment-store, branch-metadata, content-store lock keys; concurrency model documented in docs/concurrency.md |
...
| [flaky-comment-store-tests.md](flaky-comment-store-tests.md)                 | RESOLVED — layered locking in epic PR #114; {retry:1} workarounds removed, 20/20 clean runs                                    |
