...
| [cms-service-deployment-test.md](resolved/cms-service-deployment-test.md) | RESOLVED — first full prod-mode AWS deploy (epic/deployment-test, 2026-07-24): entire stack deployed to sandbox + all 9 verification rows exercised on the live editor. 16 PRs (#128–#140) fixed deploy blockers found by design review, dogfooding, template review, and the live deploy. Open follow-ups spun out (post-merge-sync-gaps P1, worker CloudWatch shipping, slug/anon 500s, pack prepack). Reusable harness kept. |
