...
| [asset-review-followups.md](asset-review-followups.md)                             | Deferred non-blocking items from PR #126 review: upload abort/AbortController, post-delete blob GC, altOptional-omitted edge, + nits (finalize byte-cap verified done 2026-07-24; transform error-status flattening fixed 2026-07-30) |
