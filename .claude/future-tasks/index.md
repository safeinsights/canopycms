...
| [e2e-occ-save-race-after-branch-create.md](e2e-occ-save-race-after-branch-create.md) | Intermittent 409 ("modified by another editor") saving right after branch create/switch — mtime-based OCC token invalidated by an unidentified post-provisioning file toucher; last remaining e2e flake (~1-2 tests/full run, never in isolation), likely a real editor-facing race (2026-07-24) |
