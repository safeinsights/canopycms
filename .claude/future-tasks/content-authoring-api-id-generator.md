...
From the 2026-08-13/14 site audits of `../docs-site-proto`, triaged as part of
the 2026-08-14 go-live backlog re-baseline. No existing task file covered
this.

## Problem

`docs-site-proto/scripts/ingest-dataset.ts` writes entry YAML files directly
...
- **Export a deterministic content-ID generator** — whatever internal
  ...
  `ingest-dataset.ts` (and any future bulk-ingest script) can generate real
  IDs instead of hand-copying the alphabet.
