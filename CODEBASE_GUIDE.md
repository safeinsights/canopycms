...
| File                     | Purpose                                                                                                                                                                                                                            |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| content-store.ts         | Content persistence (write operations); ContentStoreError with typed error codes for structural matching; `resolveReferencesInData` recurses through inline groups                                                                 |
