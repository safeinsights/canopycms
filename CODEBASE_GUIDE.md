...
| json-to-markdown.ts     | Schema-driven entry-to-markdown converter; body pipeline: `stripMdxImports → componentTransforms → bodyTransforms`; outer field loop uses `flattenGroupFields` (group early-return removed)                                |
