...
| schemas/config.ts      | Zod schema for CanopyConfig; `devConfigSchema` (+ `devContentSyncSchema` = `z.enum(['off','warn'])`, defaults `'warn'`); `dev` is an optional field on the config schema                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
