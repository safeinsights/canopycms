...
| utils/          | src/utils/          | Shared utilities (error handling, debug logging, title-field: resolveEntryTitle, findInvalidTitleFields, findTitleFieldsInLists — all traverse `type: 'group'` fields transparently by recursing into their children; body-field: countBodyFields, findInvalidBodyFields; sanitize-href: sanitizeHref) |
