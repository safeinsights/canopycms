...
| File                   | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| cli.ts                 | CLI entrypoint: minimist-based arg parsing, command routing, `isDirectRun` guard; dynamically imports command modules; `resolveSyncSubcommand()` maps positional arg to sync subcommand                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| File                  | Purpose                                                                                                                           |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| meta-loader.ts        | Load .collection.json files from filesystem; extracts ContentId from directory names; rejects "body" field name in md/mdx schemas |
