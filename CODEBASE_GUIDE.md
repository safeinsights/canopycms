...
| transform-components.ts | `applyComponentTransforms(body, transforms)`, `parseComponentProps(attrString)` — parses JSX from MDX and applies adopter-defined transforms to clean markdown; regex + convergence loop, code-block aware |
