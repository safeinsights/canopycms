...
async function main() {
  ...
  if (!githubToken) throw new Error('CANOPYCMS_GITHUB_TOKEN or CANOPYCMS_GITHUB_TOKEN_SECRET_ARN is required')
  ...
  if (!clerkSecretKey) throw new Error('CLERK_SECRET_KEY or CLERK_SECRET_KEY_SECRET_ARN is required')
