 ...
 */
export const isAdmin = (groups: string[] | undefined): boolean =>
 ...
 */
export const isReviewer = (groups: string[] | undefined): boolean =>
 ...
 */
export const isPrivileged = (groups: string[] | undefined): boolean => isReviewer(groups)
