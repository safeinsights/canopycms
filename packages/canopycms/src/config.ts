...
type _AssertSingletonConfigCompatible = Omit<SingletonConfig, 'fields'> extends Omit<z.infer<typeof singletonSchema>, 'fields'>
...
type _AssertCollectionEntriesConfigCompatible = Omit<CollectionEntriesConfig, 'fields'> extends Omit<
  z.infer<typeof collectionEntriesSchema>,
  'fields'
>
  ? Omit<z.infer<typeof collectionEntriesSchema>, 'fields'> extends Omit<CollectionEntriesConfig, 'fields'>
    ? true
...
type _AssertCollectionConfigCompatible = Omit<CollectionConfig, 'collections' | 'singletons' | 'entries'> extends {
  readonly name: string
  readonly path: string
  readonly label?: string
}
...
type _AssertRootCollectionConfigCompatible = Omit<RootCollectionConfig, 'collections' | 'singletons' | 'entries'> extends Record<string, never>
  ? true
...
type _AssertCollectionConfigChildren =
  CollectionConfig['collections'] extends readonly CollectionConfig[] | undefined
...
type _AssertRootCollectionConfigChildren =
  RootCollectionConfig['collections'] extends readonly CollectionConfig[] | undefined
