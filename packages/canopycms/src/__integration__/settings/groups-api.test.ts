...
describe('Groups API Integration', () => {
  describe('prod-sim mode', () => {
    ...
    it('should load groups from settings directory', async () => {
      // Create services
      const services = await createCanopyServices(workspace.config, { schema: BLOG_SCHEMA })
    ...
    it('should preserve groups across service restarts', async () => {
      ...
      const services1 = await createCanopyServices(workspace.config, { schema: BLOG_SCHEMA })
      ...
      const services2 = await createCanopyServices(workspace.config, { schema: BLOG_SCHEMA })
