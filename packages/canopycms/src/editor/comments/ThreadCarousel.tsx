      ...
      <Stack gap="xs">
        ...
        <Group justify="space-between" align="center">
          ...
          <Group gap="xs">
            ...
            <Button size="xs" variant="light" onClick={() => setShowNewThreadBox(!showNewThreadBox)}>
              + New
            </Button>
          </Group>
        </Group>
            ...
            {sortedThreads.length > 1 && currentIndex < sortedThreads.length - 1 && (
              <div
                style={{
                  ...
                  width: 60,
                  height: '100%',
                  background: 'linear-gradient(to left, var(--mantine-color-gray-0) 0%, transparent 100%)',
                  pointerEvents: 'none',
                }}
              />
            )}
