...
export const FormRenderer: React.FC<FormRendererProps> = ({
  ...
  const renderField = useCallback(
    (field: FieldConfig, currentValue: unknown, update: (v: unknown) => void, path: Array<string | number>) => {
      ...
      const fieldThreads = currentEntryPath && onAddComment
        ? comments.filter(
            (thread) =>
              thread.type === 'field' &&
    ...
    [customRenderers, branch, comments, currentEntryPath, currentUserId, canResolve, focusedFieldPath, highlightThreadId, onAddComment, onResolveThread]
  )
