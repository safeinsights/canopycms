...
export const Editor: React.FC<EditorProps> = ({
  ...
  const navCollections = useMemo<EntryNavCollection[] | undefined>(() => {
    ...
    const build = (node: EditorCollection): EntryNavCollection => {
      ...
      return {
        ...
        conflictNotice: !!(node.contentId && currentBranch?.conflictFiles?.includes(node.contentId)),
        onAdd:
          node.type !== 'entry'
  ...
  }, [activeCollections, entriesState, onCreateEntry, handleCreateEntry, contentRoot, currentBranch])
