...
export const Editor: React.FC<EditorProps> = ({
  ...
  const handleSubmit = () => notifications.show({ message: 'Submit flow not wired yet', color: 'blue' })
  const handleRequestChanges = () => notifications.show({ message: 'Request changes flow not wired yet', color: 'blue' })
