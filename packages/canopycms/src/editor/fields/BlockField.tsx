...
const findTemplate = (templates: BlockConfig[], name: string) => templates.find((t) => t.name === name)
...
export const BlockField: React.FC<BlockFieldProps> = ({
  ...
  const addBlock = (templateName: string) => {
    ...
    setItemKeys((prev) => [...prev, `block-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`])
  }
                    ...
                    <Stack gap="xs">
                      <Group justify="space-between" align="flex-start">
                        ...
                        <Group gap={4}>
                          ...
                          <Button variant="subtle" color="red" size="xs" onClick={() => removeBlock(idx)}>
                            Remove
                          </Button>
                        </Group>
                      </Group>
