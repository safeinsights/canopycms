  ...
  const mockComments: CommentThread[] = [
    {
      ...
      canopyPath: 'title',
      comments: [
        { id: 'c1', text: 'Field comment', author: 'user1', createdAt: new Date().toISOString() },
      ],
      resolved: false,
    ...
    },
    {
      ...
      entryId: 'entry1',
      comments: [
        { id: 'c2', text: 'Entry comment', author: 'user1', createdAt: new Date().toISOString() },
      ],
      resolved: false,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    },
    {
      ...
      type: 'branch',
      comments: [
        { id: 'c3', text: 'Branch comment', author: 'user1', createdAt: new Date().toISOString() },
      ],
      resolved: false,
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
