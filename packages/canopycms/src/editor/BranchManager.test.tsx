...
describe('getBranchPermissions', () => {
  ...
  it('allows admin to delete any branch', () => {
    ...
    const perms = getBranchPermissions(branch, { userId: 'admin', groups: [RESERVED_GROUPS.ADMINS] })
  ...
  it('allows reviewer to request changes on submitted branch', () => {
    ...
    const perms = getBranchPermissions(branch, { userId: 'reviewer', groups: [RESERVED_GROUPS.REVIEWERS] })
