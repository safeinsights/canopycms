...
export class SchemaOps {
   ...
   */
  private validatePath(targetPath: string): { valid: boolean; normalizedPath?: string; error?: string } {
   ...
   */
  async createCollection(input: CreateCollectionInput): Promise<{ collectionPath: LogicalPath; contentId: ContentId }> {
    // Validate input
   ...
   */
  async updateCollection(collectionPath: LogicalPath, updates: UpdateCollectionInput): Promise<void> {
    // Validate input
...
export { createCollectionInputSchema, updateCollectionInputSchema, entryTypeInputSchema, updateEntryTypeInputSchema }
