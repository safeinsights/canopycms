 ...
 */
async function extractPathSegments(
  ctx?: { params?: Promise<{ canopycms?: string[] }> | { canopycms?: string[] } }
): Promise<string[]> {
...
export const createCanopyCatchAllHandler = (options: CanopyNextOptions) => {
  ...
  return async (
    req: NextRequest,
    ctx?: { params?: Promise<{ canopycms?: string[]; [key: string]: any }> | { canopycms?: string[]; [key: string]: any } }
  ) => {
