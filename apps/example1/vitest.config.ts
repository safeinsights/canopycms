...
// Dev-mode branch clones (created lazily by `next dev` and the editor; a build
// never creates one) copy this entire directory -- including
// build-verify.test.ts itself -- into .canopy-dev/content-branches/<branch>/.
// Without excluding
